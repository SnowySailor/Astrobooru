      ...
      true ->
        case Subscription.cancel_subscriptions(user, reason <> ": " <> reason_text) do
          true ->
            ...
            |> put_flash(
              :info,
              "Successfully cancelled your subscription payments; your premium account will remain active until the end of the billing period"
            )
          ...
          false ->
            ...
            |> put_flash(
              :error,
              "There was an issue cancelling your subscription; please contact us to confirm that you will no longer be billed"
            )
        end
        |> redirect(external: Routes.activity_path(conn, :index))
